...
export EBOT_PLATFORMS='declare -A ebot_platforms=( [ebot]="ebots:avr:ebot8pro")'
...
ln -s $TRAVIS_BUILD_DIR $HOME/arduino_ide/hardware/arduino/avr/libraries/SoftwareSerial/examples/SoftwareSerialExample
...
DEPENDENCY_OUTPUT=$(arduino --pref "boardsmanager.additional.urls=https://raw.githubusercontent.com/sanu-krishnan/ebot-arduino-core/master/package_ebots.cc_index.json" --save-prefs 2>&1)
...
echo -n "EBOT AVR: "
DEPENDENCY_OUTPUT=$(arduino --install-boards ebot:avr 2>&1)
